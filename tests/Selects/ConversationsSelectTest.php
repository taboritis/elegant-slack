...
#[CoversClass(ConversationsSelect::class)]
class ConversationsSelectTest extends TestCase
{
    #[Test]
    public function it_extends_a_select(): void
    {
        $reflector = new \ReflectionClass(ConversationsSelect::class);
    ...
    {
        $select = new ConversationsSelect('Choose a conversation', 'action-id');
